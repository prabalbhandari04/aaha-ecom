...
class OrderItem(models.Model):
    ...
    quantity=models.IntegerField(null=True,blank=True)
    item=models.ForeignKey(Product,  verbose_name=("order_items_relation"),on_delete=models.CASCADE,null=True,blank=True)
    variant=models.ForeignKey(Variant, on_delete=models.CASCADE,blank=True,null=True)
...
class Order(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.identifier=bcrypt.hashpw(str(str(self.id)+str(self.user_id)).encode(), bcrypt.gensalt())
