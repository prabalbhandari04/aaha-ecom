...
import Seller from './profile/sellerProfile';
import AddProduct from './profile/sellAddProduct';
// import seller from './profile/sellerProfile';
// import profedit from './profile/userProfile_Edit';
// import proforder from './profile/userProfile_Order';
// import Seller from './profile/sellerProfile';
// import UserEdit from './profile/userProfile_Edit';
// import UserOrder from './profile/userProfile_Order';
  ...
  return (
    <>
      <div className="bg-inverse flex mx-5">
            ...
            <div className="my-5 w-1/6 h-full">
            ...
            {/* Main body */}
            <div className="w-4/6 min-h-screen rounded-lg bg-primary">
                {/* SearchBar */}
                <div className="my-5 mx-8 w-auto">
